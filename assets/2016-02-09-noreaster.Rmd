...
names
d <- tail(d, -2) # 2nd line holds units but we know them
...
As for the tendency for large waves for wind coming from the east, that may be
a fetch effect, for the buoy is off the east coast of Canada.
