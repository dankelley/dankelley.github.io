...
<div class=slug>
    ...
    <div class=post_summary>
        GISS has new data since 2014, with typical difference on the overlapping time window by about 0.1deg.
    </div> <!-- post_summary -->
</div> <!-- slug -->
...
The datassets differ. It would be a good idea to read the [NASA
documentation](http://data.giss.nasa.gov/gistemp) on the evolution of the
dataset.


```{r fig.width=7, fig.height=7, dpi=120}
