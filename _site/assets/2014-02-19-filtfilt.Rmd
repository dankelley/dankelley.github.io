...
<div class="highlight"><pre><code class="matlab"><span class="k">function</span><span class="w"> </span>y <span class="p">=</span><span class="w"> </span><span class="nf">filtfilt</span><span class="p">(</span>b, a, x<span class="p">)</span><span class="w"></span>
