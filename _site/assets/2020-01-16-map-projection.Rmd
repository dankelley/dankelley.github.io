...
<meta charset="UTF-8">
<title>oce map projections available in PROJ6</title>
</head>
...
<div class="page-header">
    ...
    <div class=post_title>oce map projections available in PROJ6</div>
<!-- </div> --> <!-- span8 -->
...
<div class=slug>
    ...
    <div class=post_summary>
        This blog posting tests whether the projections used in a previous posting about oce will work with the `sf` scheme.
    </div> <!-- post_summary -->
</div> <!-- slug -->
