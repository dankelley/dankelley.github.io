...
<div class="highlight"><pre><code class="latex">Limits may be infinite if set to <span class="k">\texttt</span><span class="nb">{</span>Inf<span class="nb">}</span>, e.g. for the witch of Agnesi
function
&lt;&lt;&gt;&gt;=
woa &lt;- function(x, a=1)
