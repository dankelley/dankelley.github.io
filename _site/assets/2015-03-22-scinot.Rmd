...
<span class="nb">@</span>
<span class="nb">the results differ from the true value </span><span class="s">$</span>4<span class="k">\pi</span><span class="s">$</span><span class="nb"> by </span><span class="s">$</span><span class="k">\Sexpr</span><span class="nb">{</span>scinot(err, 0)<span class="nb">}</span><span class="s">$</span><span class="nb">.</span>
</code></pre></div>
