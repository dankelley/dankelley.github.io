...
and a latex test use is
<div class="highlight"><pre><code class="latex">Limits may be infinite if set to <span class="k">\code</span><span class="nb">{</span>Inf<span class="nb">}</span>, <span class="k">\eg</span> for the <span class="k">\di</span><span class="nb">{</span>witch of Agnesi<span class="nb">}</span>
function
&lt;&lt;&gt;&gt;=
woa &lt;- function(x, a=1)
    8 * a<span class="nb">^</span>3 / (x<span class="nb">^</span>2 + 4*a<span class="nb">^</span>2)
integrate(woa, -Inf, Inf)
@
&lt;&lt;results=hide, echo=false&gt;&gt;=
woa &lt;- function(x, a=1)
    8 * a<span class="nb">^</span>3 / (x<span class="nb">^</span>2 + 4*a<span class="nb">^</span>2)
i &lt;- integrate(woa, -Inf, Inf)<span class="s">$</span><span class="nb">value</span>
<span class="nb">err &lt;</span><span class="o">-</span><span class="nb"> abs</span><span class="o">((</span><span class="nb">i </span><span class="o">-</span><span class="nb"> </span><span class="m">4</span><span class="nb"> </span><span class="o">*</span><span class="nb"> pi</span><span class="o">)</span><span class="nb"> </span><span class="o">/</span><span class="nb"> </span><span class="o">(</span><span class="m">4</span><span class="nb"> </span><span class="o">*</span><span class="nb"> pi</span><span class="o">))</span><span class="nb"></span>
<span class="nb">@</span>
<span class="nb">differs from the true value </span><span class="s">$</span>4<span class="k">\pi</span><span class="s">$</span><span class="nb"> by </span><span class="s">$</span><span class="k">\Sexpr</span><span class="nb">{</span>scinot(err, 0)<span class="nb">}</span><span class="s">$</span><span class="nb">.</span>
</code></pre></div>
```
...
1. R source code used here: [2215-03-22-scinot.R](/assets/2215-03-22-scinot.R).
