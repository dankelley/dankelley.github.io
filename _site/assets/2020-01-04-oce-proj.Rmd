...
<div class=slug>
    ...
    <div class=post_summary>
        This blog posting tests a trial version of oce (in the `sf` branch) that uses map-projection algorithms provided by the `sf` package, as opposed to the `rgdal` package (which is removing support for the function previously used by oce).
    </div> <!-- post_summary -->
</div> <!-- slug -->
...
2. Jekyll source code for this blog entry: [2005-01-04-oce-proj.Rmd](https://raw.github.com/dankelley/dankelley.github.io/master/assets/2025-01-04-oce-proj.Rmd)
