...
is only on the git branch named ``project_with_rgdal``. The results with this
version of oce seem to be very close to those with the previous system, with
differences only in the cases where extraneous lines are seen.
...
{% highlight text %}
## Error in if (poleInView) {: missing value where TRUE/FALSE needed
{% endhighlight %}
...
{% highlight text %}
## Error in mapPlot(coastlineWorld, projection = p, col = col, longitudelim = c(-180, : All the data are 'on the other side of the world' for this map projection
{% endhighlight %}
...
![center](http://dankelley.github.io/figs/2015-04-03-oce-proj/unnamed-chunk-1-99.png)
...
![center](http://dankelley.github.io/figs/2015-04-03-oce-proj/unnamed-chunk-1-100.png)
...
![center](http://dankelley.github.io/figs/2015-04-03-oce-proj/unnamed-chunk-1-101.png)
