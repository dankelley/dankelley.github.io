...
oce version 0.9-17. However, a CRAN member
suggested removing the PROJ.4 code from oce when 0.9-17 was being vetted, and
so later versions of 'oce' rely on the 'rgdal' package.

Oce only provides those PROJ.4 projections that have inverses.
